...
const YetAnotherInsect = struct {
    age: u8,

    pub fn print(self: YetAnotherInsect) void {
        std.debug.print("this comes from yet another insect with age: {}", .{self.age});
    }
};
...
const Insect = union(enum) {
    ...
    yetAnotherInsect: YetAnotherInsect,
